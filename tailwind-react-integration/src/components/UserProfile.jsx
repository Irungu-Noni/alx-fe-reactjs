function UserProfile() {
    return (
        <div className="bg-gray-100 sm:p-4 md:p-8 p-8 sm:max-w-xs md:max-w-sm max-w-sm mx-auto,my-20 rounded-lg shadow-lg hover:shadow-xl">
            <img className="rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 w-36 h-36 mx-auto hover:scale-110 transition-transform duration-300 ease-in-out" src="https://via.placeholder.com/150" alt="User" />
